<div class="createComment">
	<form method='POST' enctype="multipart/form-data">
		...
		<textarea class="commentForm" name="commentText"><?php 
		...
		<div class="commentForm__action"> 
			...
			<button type="submit" formaction="<?=$_SESSION['constants']['CURRENT_DOMEN']; ?>preview" class="preview"><p>Предпросмотр</p></button>
